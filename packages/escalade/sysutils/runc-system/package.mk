...
PKG_DEPENDS_HOST="toolchain go:host"
...
unpack() {
  tar -C $BUILD -zxf $SOURCES/$PKG_NAME/runc-system-$PKG_VERSION.tar.gz
  mv $BUILD/runc-$PKG_VERSION $BUILD/$PKG_NAME-$PKG_VERSION
}
